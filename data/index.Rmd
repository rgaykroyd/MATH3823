...
In Exercise 1.5.1, you can access the file here: [beetle.txt](https://rgaykroyd.github.io/MATH3823/Datasets/beetle.txt) but also it can be read-in directly from within R using:

```{r}
beetle = read.table("https://rgaykroyd.github.io/MATH3823/Datasets/beetle.txt", header=T)
```

In Exercise 1.5.5, you can access the file here: [physics_from_data.csv](https://rgaykroyd.github.io/MATH3823/Datasets/physics_from_data.csv) but also it can be read-in directly from within R using: 

```{r}
physics = read.csv("https://rgaykroyd.github.io/MATH3823/Datasets/physics_from_data.csv", header=T)
```

In Exercise 2.6.4, you can access the file here: [barley.csv](https://rgaykroyd.github.io/MATH3823/Datasets/barley.csv) but also it can be read-in directly from within R using: 
